...
- [KanjiVG](https://github.com/KanjiVG/kanjivg)：用于假名跟写功能的字形与笔顺数据来源。本项目仅提取并转换了日学当前所需的平假名 / 片假名子集，生成轻量的运行时跟写数据。KanjiVG copyright (C) 2009/2010/2011 Ulrich Apel，采用 [Creative Commons Attribution-Share Alike 3.0](https://creativecommons.org/licenses/by-sa/3.0/) 许可。KanjiVG 官网：[kanjivg.tagaini.net](http://kanjivg.tagaini.net)。相关生成数据的说明见 [src/assets/kana-trace/NOTICE.txt](src/assets/kana-trace/NOTICE.txt)。

### 素材、音效与语音

- [効果音ラボ](https://soundeffect-lab.info/)
- [Kenney](https://kenney.nl/)
- [小春音アミ](https://amitaro.net/utau/)：用于日语入门五十音内置假名读音素材。相关音频素材不包含在本项目根目录 MIT License 的授权范围内；如需复用、再分发或修改，请先阅读并遵守原站使用条款：[amitaro.net/utau/licence01.html](https://amitaro.net/utau/licence01.html)。项目内说明见 [src/assets/audio/gojuon/NOTICE.txt](src/assets/audio/gojuon/NOTICE.txt)。
